...
- Install the latest version of electron by running `npm install -g electron`
- NPM will install electron globally. You can use it on every of your electron projects now.
