...
const Playlist: React.FC = () => {
	...
	const { tracks, trackPlayingId, playerStatus, playlists, currentPlaylist, library } = useSelector(
		(state: RootState) => {
			...
			return {
				...
				trackPlayingId:
					player.queue.length > 0 && player.queueCursor !== null
						? player.queue[player.queueCursor]._id
						: null,
			};
		}
	);
