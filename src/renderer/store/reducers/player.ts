...
const initialState: PlayerState = {
  ...
  repeat: window.__museeks.config.get('audioRepeat'), // the current repeat state (one, all, none)
  shuffle: window.__museeks.config.get('audioShuffle'), // If shuffle mode is enabled
