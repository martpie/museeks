...
var MusicFoldersList = React.createClass({displayName: "MusicFoldersList",
    ...
    componentDidMount: function () {
        var addFolderInput = document.querySelector('.nwdirectory');
        addFolderInput.setAttribute('nwdirectory', '');
    },
    render: function () {
        ...
        return (
            React.createElement("div", {className: "settings-musicfolder"}, 
                ...
                React.createElement("input", {type: "file", className: "nwdirectory", onChange:  this.addFolder}), 
    ...
    addFolderInput: function () {
        ...
        document.querySelector('.nwdirectory').click();
    },
    addFolder: function () {
