...
export default function TrackList(props: Props) {
  ...
  const tracks: Array<Track> =
    layout === 'default' ? data : data.flatMap((group) => group.tracks);
   ...
   * Helpers
   */
  const onPlaybackStart = (trackID: string) => {
  ...
  const onTrackSelect = (
    ...
    setSelectedTracks(listMouseSelect(tracks, selectedTracks, trackID, event));
  };
