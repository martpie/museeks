...
fn sample_track_1() -> Track {
    Track {
        ...
        title_sort: Some("Song One".to_string()),
        album: "Album One".to_string(),
        album_sort: Some("Album One".to_string()),
        album_artist: "Artist One".to_string(),
        album_artist_sort: Some("Artist One".to_string()),
...
fn sample_track_2() -> Track {
    Track {
        ...
        title_sort: Some("Song Two".to_string()),
        album: "Album Two".to_string(),
        album_sort: Some("Album Two".to_string()),
        album_artist: "Artist Two".to_string(),
        album_artist_sort: Some("Artist Two".to_string()),
...
fn sample_track_3() -> Track {
    Track {
        ...
        title_sort: Some("Song Three".to_string()),
        album: "Album Three".to_string(),
        album_sort: Some("Album Three".to_string()),
        album_artist: "Artist Three".to_string(),
        album_artist_sort: Some("Artist Three".to_string()),
